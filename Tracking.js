...
/* =========================================
   XYNZ MAIL — TRACKING PAGE SCRIPT
   Modern Professional Interaction
========================================= */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const shipmentDatabase = {
    ...
    "XYNZ-78124": {
      ...
      eta: "Successfully Delivered"
    },

    "XYNZ-99231": {
      status: "Processing",
      location: "Dubai Cargo Hub",
      eta: "Preparing Shipment"
    }
  };

  function createTrackingPopup(data, trackingNumber) {

    // Remove old popup if exists
    const oldPopup = document.querySelector(".tracking-popup");
    ...
    popup.innerHTML = `
      <div class="tracking-popup-card">

        <button class="tracking-close">
          <i class="fa-solid fa-xmark"></i>
        </button>

        <div class="tracking-popup-top">
          ...
          <p>Your shipment information has been updated successfully.</p>
        </div>
    ...
    // Close popup
    popup.querySelector(".tracking-close")
  ...
  function createErrorPopup(message) {
    ...
    popup.innerHTML = `
      <div class="tracking-popup-card tracking-error-card">
  ...
  if (trackBtn) {
    ...
    trackBtn.addEventListener("click", () => {
      ...
      setTimeout(() => {
        ...
        const shipment =
          shipmentDatabase[trackingValue];
  ...
  /* =========================================
     VEHICLE LIVE STATUS ANIMATION
  ========================================= */

  const liveDots =
    document.querySelectorAll(".live-dot");
  ...
  /* =========================================
     TRACKING INPUT GLOW EFFECT
  ========================================= */

  if (trackingInput) {

    trackingInput.addEventListener("focus", () => {
      trackingInput.parentElement.classList.add("input-focus");
    });

    trackingInput.addEventListener("blur", () => {
      trackingInput.parentElement.classList.remove("input-focus");
    });
